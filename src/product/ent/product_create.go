...
func (_c *ProductCreate) SetTotalStock(v int64) *ProductCreate {
	_c.mutation.SetTotalStock(v)
	return _c
}

// SetRemainingStock sets the "remaining_stock" field.
func (_c *ProductCreate) SetRemainingStock(v int64) *ProductCreate {
...
func (_c *ProductCreate) check() error {
	...
	if _, ok := _c.mutation.TotalStock(); !ok {
		return &ValidationError{Name: "total_stock", err: errors.New(`ent: missing required field "Product.total_stock"`)}
	}
	if _, ok := _c.mutation.RemainingStock(); !ok {
		return &ValidationError{Name: "remaining_stock", err: errors.New(`ent: missing required field "Product.remaining_stock"`)}
	}
	return nil
}
