...
func (_c *GreeterCreate) SetHello(v string) *GreeterCreate {
	_c.mutation.SetHello(v)
	return _c
}
...
func (_c *GreeterCreate) check() error {
	if _, ok := _c.mutation.Hello(); !ok {
		return &ValidationError{Name: "hello", err: errors.New(`ent: missing required field "Greeter.hello"`)}
	}
	return nil
}
...
func (_c *GreeterCreate) createSpec() (*Greeter, *sqlgraph.CreateSpec) {
	...
	if value, ok := _c.mutation.Hello(); ok {
