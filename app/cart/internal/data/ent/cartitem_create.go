...
func (_c *CartItemCreate) SetName(v string) *CartItemCreate {
	_c.mutation.SetName(v)
	return _c
}

// SetPriceCents sets the "price_cents" field.
func (_c *CartItemCreate) SetPriceCents(v int64) *CartItemCreate {
	_c.mutation.SetPriceCents(v)
	return _c
}

// SetNillablePriceCents sets the "price_cents" field if the given value is not nil.
func (_c *CartItemCreate) SetNillablePriceCents(v *int64) *CartItemCreate {
	if v != nil {
		_c.SetPriceCents(*v)
	}
	return _c
...
func (_c *CartItemCreate) SetNillableCurrency(v *string) *CartItemCreate {
	if v != nil {
		_c.SetCurrency(*v)
	}
	return _c
...
func (_c *CartItemCreate) SetImageURL(v string) *CartItemCreate {
	_c.mutation.SetImageURL(v)
	return _c
}

// SetNillableImageURL sets the "image_url" field if the given value is not nil.
func (_c *CartItemCreate) SetNillableImageURL(v *string) *CartItemCreate {
	if v != nil {
		_c.SetImageURL(*v)
	}
	return _c
...
func (_c *CartItemCreate) defaults() {
	if _, ok := _c.mutation.PriceCents(); !ok {
		v := cartitem.DefaultPriceCents
		_c.mutation.SetPriceCents(v)
	}
	if _, ok := _c.mutation.Currency(); !ok {
		v := cartitem.DefaultCurrency
		_c.mutation.SetCurrency(v)
	}
...
func (_c *CartItemCreate) check() error {
	...
	if _, ok := _c.mutation.PriceCents(); !ok {
		return &ValidationError{Name: "price_cents", err: errors.New(`ent: missing required field "CartItem.price_cents"`)}
	}
	if _, ok := _c.mutation.Currency(); !ok {
